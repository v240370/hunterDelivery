...
class PayMobServices {
  ...
  Future<String> authentication(String _apiKey) async {
    try {
      var response = await http.post('https://accept.paymobsolutions.com/api/auth/tokens',
  ...
  createOrder(String itemPrice, String orderId) async {
    ...
    try {
      var response = await http.post("https://accept.paymobsolutions.com/api/ecommerce/orders",
          body: convert.jsonEncode({
  ...
  executePayment(String _integrationId, String _frame,
    ...
    try {
      ...
      var response = await http.post("https://accept.paymobsolutions.com/api/acceptance/payment_keys",
          body: _body,
          headers: {
            "content-type": "application/json",
